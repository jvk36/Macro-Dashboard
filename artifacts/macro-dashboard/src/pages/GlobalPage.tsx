...
function StaleAlert({ text }: { text?: string }) {
  if (!text) return null;
  return (
    <div className="flex items-start gap-2.5 rounded-lg border border-zinc-800 px-3.5 py-2.5">
      <svg
      ...
      <p className="text-[11px] font-bold text-zinc-400 leading-relaxed">{text}</p>
    </div>
  );
}
